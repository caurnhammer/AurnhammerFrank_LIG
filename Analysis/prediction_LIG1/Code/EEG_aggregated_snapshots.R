# Christoph Aurnhammer, Feb 16 2019
# Analyse snapshots on aggregated N400 data (Frank et al., 2015) in a linear model

rm(list=ls())

data = read.csv('../Input_data/eeg_srp_klduni_avg_snapshots.csv', sep = '\t')
