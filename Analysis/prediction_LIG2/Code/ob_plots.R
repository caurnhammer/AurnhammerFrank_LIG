...
setwd("/Users/chr/R/prediction/prediction_forward/Code/")

# Set metric labels
metrics = c(expression("Lookahead information gain"[2]), "Surprisal")
...
et_plt <- et_plt + scale_color_grey(start=0.2, end=0.6, labels=metrics)
